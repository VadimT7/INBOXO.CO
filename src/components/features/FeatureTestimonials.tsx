...
const testimonials = [
  {
    ...
    quote: 'Inboxo transformed our lead management. We went from 23% to 87% lead qualification accuracy in just 3 months. The AI scoring is incredibly accurate.',
    rating: 5,
  ...
  },
  {
    ...
    quote: 'Inboxo paid for itself in half a day - it\'s this good! The AI-generated responses are so natural and absolutely undistinguishable from human responses.',
    rating: 5,
